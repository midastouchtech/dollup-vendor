...
const EditServicePage = ({ vendor, socket }) => {
  ...
  if (socket && !details) {
    socket.emit("GET_SERVICE", { id: serviceId });
  ...
  const handleSubmit = () => {
    ...
    console.log(details);
    const detailsWithDuration = details?.duration
      ? details
      : assoc("duration", { hours: 0, minutes: 0 }, details);
    ...
    if (socket && !isEmpty(details)) {
      ...
      socket.on("RECEIVE_UPDATE_SERVICE_SUCCESS", () => {
        notification.success({
          message: "Success!",
          description: "Your service info has been updated!",
        });
                  ...
                  <div className="ps-block__content">
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => setDetail("salePrice", e.target.value)}
                      />
                    </div>
                    <div className="form-group">
                  ...
                  <div className="ps-block__content">
                    <div className="form-group">
                      ...
                      <Upload
                        ...
                        onUploadComplete={(url) => setDetail("thumbnail", url)}
                      />
                    </div>
                    <div className="form-group">
                      ...
                      <div className="form-group--nest">
                        <Upload
                          existingFileList={
                            details?.galeryImage1
                              ? [{ url: details?.galeryImage1 }]
                              : []
                          }
                    ...
                    <div className="form-group form-group--nest">
                      <Upload
                        existingFileList={
                          details?.galeryImage2
                            ? [{ url: details?.galeryImage2 }]
                            : []
                        }
                        onUploadComplete={(url) =>
